...
Para obtener más información sobre la configuración de roles de RBAC de ONTAP, consulte la http://docs.netapp.com/ontap-9/topic/com.netapp.doc.pow-adm-auth-rbac/home.html["Guía completa de autenticación de administrador y RBAC de ONTAP 9"^].
