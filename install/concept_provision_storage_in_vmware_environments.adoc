...
El disco compartido no se crea utilizando el Plug-in for Windows. Debes crear y luego agregar la LUN compartida a cada máquina virtual en el clúster.



=== Información relacionada

Consulta https://techdocs.broadcom.com/["Documentación técnica de Broadcom"^] y busca documentación sobre la agrupación en clúster de máquinas virtuales entre hosts físicos y la creación de LUN FC RDM compartidos para clústeres de Microsoft.
