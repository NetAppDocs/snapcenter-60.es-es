...
NOTE: Solo se admite la autenticación basada en contraseña cuando se instala el plugin en Oracle RAC. No se admite la autenticación basada en claves SSH.
