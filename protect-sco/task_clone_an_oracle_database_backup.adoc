...
.. Especifique el nombre de la PDB clonada. Para obtener los pasos detallados para clonar una PDB, consulte link:../protect-sco/task_clone_a_pluggable_database.html["Clonar una base de datos conectable"^].
...
+
Puede agregar parámetros adicionales haciendo clic en *image:../media/add_policy_from_resourcegroup.gif[""]*.
