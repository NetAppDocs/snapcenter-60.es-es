...
NOTE: Los pares clave-valor personalizados son compatibles con los sistemas de plugins de Linux PostgreSQL y no son compatibles con el clúster PostgreSQL registrado como un plugin centralizado de Windows.
