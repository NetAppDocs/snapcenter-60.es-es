...
---
= Requisitos del host para instalar el paquete de plugins de SnapCenter para Linux y AIX
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Debe asegurarse de que el host cumpla los requisitos antes de instalar el paquete de plugins de SnapCenter para Linux o AIX.
