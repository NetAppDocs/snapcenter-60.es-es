...
---
= Supervisar las operaciones de copia de seguridad de IBM DB2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Supervise las operaciones de protección de datos en las bases de datos IBM DB2 en el panel Activity
