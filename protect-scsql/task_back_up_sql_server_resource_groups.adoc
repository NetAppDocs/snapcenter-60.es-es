...
+
Puede buscar el grupo de recursos ingresando su nombre en el cuadro de búsqueda o seleccionando * * y, luego, seleccionando laimage:../media/filter_icon.png["Icono de filtro"]etiqueta. A continuación, puede seleccionar *image:../media/filter_icon.png["Icono de filtro"]* para cerrar el panel de filtros.
