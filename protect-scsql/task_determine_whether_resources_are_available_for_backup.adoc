...
+
Haga clic image:../media/filter_icon.png["icono de filtro"] en y seleccione el nombre de host y la instancia de SQL Server para filtrar los recursos. A continuación, puede hacer clic en image:../media/filter_icon.png["icono de filtro"] para cerrar el panel de filtros.
