...
Para configurar el certificado CA con SnapCenter Plug-in for VMware vSphere, consulta https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["Crear o importar certificado SSL"^].
